                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Surat dengan nomor
                                                                <strong>{{ $surat->nomor_surat }}</strong> akan dihapus.
                                                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="{{ url('surat/detail/' . $surat->jenis_surat . '/' . $surat->id) }}"
                                                            target="_blank" class="btn btn-link btn-primary px-2"
                                                            data-bs-toggle="tooltip" title="Lihat Surat"
                                                            data-original-title="Lihat Surat">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        @if (Auth::user()->role == 'Admin' ||
                                                                $surat->id_pembuat_surat == Auth::user()->id ||
