                                        ...
                                        @foreach ($surats as $surat)
                                            ...
                                            <tr>
                                                            ...
                                                            <div class="form-button-action">
                                                                @if ($surat->nomor_surat_tugas)
                                                                    <button type="button" data-bs-toggle="tooltip"
                                                                        title="Copy Nomor Surat Tugas"
                                                                        class="btn btn-link btn-primary px-2"
                                                                        onclick="copyText('{{ $surat->nomor_surat_tugas }}')">
                                                                        <i class="fa fa-copy"></i>
                                                                    </button>
                                                                @else
                                                                    <form
                                                                        action="{{ route('surat.generate-surat-tugas', ['id_kegiatan' => $surat->id_kegiatan, 'id_form_permintaan' => $surat->id]) }}">
                                                                        <button type="submit" data-bs-toggle="tooltip"
                                                                            title="Buat Nomor Surat Tugas"
                                                                            class="btn btn-link btn-primary px-2"
                                                                ...
                                                                @if ($surat->spd_id)
                                                                    <button type="button" data-bs-toggle="tooltip"
                                                                        title="Copy Nomor SPD"
                                                                        class="btn btn-link btn-primary px-2"
                                                                        onclick="copyText('{{ $surat->nomor_surat_spd }}')">
                                                                        <i class="fa fa-copy"></i>
                                                                    </button>
                                                                @else
                                                                    <form
                                                                        action="{{ route('surat.generate-spd', ['id_kegiatan' => $surat->id_kegiatan, 'id_form_permintaan' => $surat->id]) }}">
                                                                        <button type="submit" data-bs-toggle="tooltip"
                                                                            title="Buat Nomor SPD"
                                                                            class="btn btn-link btn-primary px-2"
                                                                ...
                                                                @endif
                                                                <button type="button" data-bs-toggle="tooltip"
                                                                    title="Laporan" class="btn btn-link btn-primary px-2"
                                                ...
                                                <th scope="row">
                                                    {{ $surat->nomor_surat }}
                                                    <button type="button" data-bs-toggle="tooltip"
                                                        title="Copy Nomor Surat" class="btn btn-link btn-primary px-2"
                                                        onclick="copyText('{{ $surat->nomor_surat }}')">
                                                        <i class="fa fa-copy"></i>
                                                    </button>
                                                </th>
                                                <td>{{ \Carbon\Carbon::parse($surat->created_at)->translatedFormat('d F Y') }}
                                                </td>
