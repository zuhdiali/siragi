    ...
    <div class="container">
        <div class="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ url('surat/update/' . $jenis . '/' . $surat->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                            ...
                                            <div
                                                ...
                                                <select class="form-select" id="tim" name="tim"
                                                    ...
                                                    <option value="11011" {{ $surat->tim == '11011' ? 'selected' : '' }}>
                                                        Umum</option>
                                                    <option value="11012" {{ $surat->tim == '11012' ? 'selected' : '' }}>
                                                        Statistik Sosial</option>
                                                    <option value="11013" {{ $surat->tim == '11013' ? 'selected' : '' }}>
                                                        Statistik Ekonomi Produksi</option>
                                                    <option value="11015" {{ $surat->tim == '11015' ? 'selected' : '' }}>
                                ...
                                @if ($jenis != 'masuk' && $jenis != 'sk' && $jenis != 'bast')
                                    <div class="row">
                                        <div class="col">
                                            <hr />
                                            <h5>
                                                ...
                                                <span class="kemungkinan_no_surat">
                                                    ...
                                                    @endif
                                                    <span
                                                        id="no-surat">{{ str_pad($noTerakhir, 4, '0', STR_PAD_LEFT) }}</span>/<span
                                                        id="kode-tim">{{ $jenis != 'keluar' ? $surat->tim : '11010' }}</span>/<span
                                                        id="kode-surat">{{ $surat->kode_surat }}</span>/<span>{{ $surat->tahun }}</span>
                                                </span>
                                            </h5>
                            ...
                            <div class="card-action">
                                <button type="submit" class="btn btn-success">Edit @if ($jenis != 'masuk' && $jenis != 'spk')
                                        Nomor
                                    @endif Surat</button>
                            </div>
                        </form>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#single-select-field, #single-select-field-2, #no_spk').select2({
                theme: "bootstrap-5",
