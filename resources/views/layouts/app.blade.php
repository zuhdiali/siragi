            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="{{ route('index') }}" class="logo">
                        <img src="{{ asset('img/siragi.svg') }}" alt="navbar brand" class="navbar-brand"
                            height="30" />
                    </a>
                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ str_contains(Request::path(), 'pembayaran') ? 'show' : '' }}"
                                id="submenupembayaran">
                    ...
                    <a href="{{route('pembayaran.honor')}}">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ str_contains(Request::path(), 'surat') ? 'show' : '' }}"
                                id="submenu">
                                <ul class="nav nav-collapse">
                  ...
                  <a href="{{route('rekap')}}">
                    ...
                    <a href="{{route('penilaian.ruangan.index')}}">
                        ...
                        @if (Auth::user()->role == 'Admin')
                            <li
                                class="nav-item {{ str_contains(Request::path(), 'mitra') && !str_contains(Request::path(), 'pembayaran') && !str_contains(Request::path(), 'honor') ? 'active' : '' }}">
